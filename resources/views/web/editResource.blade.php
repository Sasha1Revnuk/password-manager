...
@section('content')
            ...
            <div class="panel">
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-container show">
                            <div class="panel-content">
                                {{--action="{{route('addResource', ['user'=>$user->id, 'resource' => $resource->id])}}"--}}
                                <form method="post"  id="webs" data-user="{{\Illuminate\Support\Facades\Auth::id()}}">
                                    @csrf
                                    @if(session('message'))
                                    ...
                                    @if($resource->method === \App\Enumerators\UserEnumerator::METHOD_SECRET)
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <input type="password" name="secretCheckedPassword" id="secretCheckedPassword" class="form-control" placeholder="Секретний пароль для підтвердження редагування" title="Секретний пароль для підтвердження редагування">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <input type="text" name="login" id="loginModalEdit" class="form-control" placeholder="Логін" value="{{old('login', $resource->login)}}">
                                        </div>

                                        <div class="form-group col-lg-12">
                                            <div class="input-group flex-nowrap">
                                                <hr />
                                                <input id="passwordModalEdit" value="{{$password}}" name="password" type="password" class="form-control passwordModalEdit" placeholder="Пароль" aria-label="Пароль" aria-describedby="passwordModal">
                                                <div class="input-group-append">
                                                    <button class="input-group-text waves-effect changeTypePassword" title="Показати пароль" data-input="#passwordModalEdit" data-method="{{$resource->method}}" data-i="#passwordI"><i class="fal fa-toggle-off fs-xl" id="passwordI"></i></button>
                                                </div>
                                                <div class="input-group-append">
                                                ...
                                                <div class="tab-content py-3 text-left ">
                                                    <div class="tab-pane fade show active" id="nav_pills_default-1" role="tabpanel">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="custom-control-input" id="secret" value="1" name="shifr" @if($resource->method === \App\Enumerators\UserEnumerator::METHOD_SECRET) checked @endif>
    ...
    <div class="modal fade" id="EditWebModal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                    <form class="col-lg-12 text-center" id="editModalForm">
                        <div class="form-group col-lg-12">
                            <input type="text" id="urlModalEdit" class="form-control" placeholder="Посилання">
                        </div>
                        <div class="form-group col-lg-12">
                            <input type="text" id="loginModalEdit" class="form-control" placeholder="Логін">
                        </div>

                        <div class="form-group col-lg-12">
                            <div class="input-group flex-nowrap">
                                <hr />
                                <input id="passwordModalEdit" type="password" class="form-control passwordModalEdit" placeholder="Пароль" aria-label="Пароль" aria-describedby="passwordModal">
                                <div class="input-group-append">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-themed" id="editToModal">Додати</button>
                </div>
            </div>
        </div>
    </div>
