  ...
  $('body').on('click', '.delete', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          type: 'POST',
          url: '/api/data/' + $('#notes').attr('data-user') + '/notes/delete/' + $(_this).attr('data-id'),
          headers: authHeaders
...
/***/ 7:
/*!**********************************!*\
  !*** multi ./resources/js/notes ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\Учеба\password-manager\resources\js\notes */"./resources/js/notes.js");
