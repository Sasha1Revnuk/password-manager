...
/***/ "./resources/js/acc/panel/programSales.js":
/*!************************************************!*\
  !*** ./resources/js/acc/panel/programSales.js ***!
  \************************************************/
/*! no exports provided */
...
$(document).ready(function () {
  var table = $('#programSales').DataTable({
    processing: true,
    serverSide: true,
    lengthMenu: [10, 25, 50],
    searching: false,
    ...
    ajax: {
      url: '/account/api/object/' + $('#programSales').attr('data-object') + '/control-panel/program-sales',
      type: "GET",
      data: {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Swal.fire({
              title: 'Причина відміни продажі програми ' + $(this).attr('data-program'),
              input: 'textarea',
          ...
          case 2:
            ...
            if (description) {
              $.ajax({
                type: 'GET',
                url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/program-sales/change-status/' + $(this).attr('id'),
                headers: authHeaders,
                data: {
                ...
                if (response.status === true) {
                  Swal.fire("\u041F\u0440\u043E\u0434\u0430\u0436 \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u0438 \u0432\u0456\u0434\u043C\u0456\u043D\u0435\u043D\u043E");
                }
              });
            }
...
/***/ 24:
/*!******************************************************!*\
  !*** multi ./resources/js/acc/panel/programSales.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\WEB\gym-control\resources\js\acc\panel\programSales.js */"./resources/js/acc/panel/programSales.js");
