...
/***/ "./resources/js/acc/panel/coaches.js":
/*!*******************************************!*\
  !*** ./resources/js/acc/panel/coaches.js ***!
  \*******************************************/
...
$(document).ready(function () {
  var table = $('#coaches').DataTable({
    ...
    ajax: {
      url: '/account/api/object/' + $('#coaches').attr('data-object') + '/control-panel/coaches',
      type: "GET",
      data: {
  ...
  $('body').on('click', '.change-status', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/coaches/change-status/' + $(this).attr('id'),
      headers: authHeaders
  ...
  $('body').on('click', '.restore', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/coaches/restore/' + $(this).attr('id'),
      headers: authHeaders
    }).then(function (response) {
      table.ajax.reload();
    });
...
/***/ 8:
/*!*************************************************!*\
  !*** multi ./resources/js/acc/panel/coaches.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\WEB\gym-control\resources\js\acc\panel\coaches.js */"./resources/js/acc/panel/coaches.js");
