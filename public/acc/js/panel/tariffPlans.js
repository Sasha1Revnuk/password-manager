...
/***/ "./resources/js/acc/panel/tariffPlans.js":
/*!***********************************************!*\
  !*** ./resources/js/acc/panel/tariffPlans.js ***!
  \***********************************************/
...
$(document).ready(function () {
  var table = $('#tariffPlans').DataTable({
    processing: true,
    serverSide: true,
    lengthMenu: [10, 25, 50],
    searching: false,
    ...
    ajax: {
      url: '/account/api/object/' + $('#tariffPlans').attr('data-object') + '/control-panel/tariff-plans',
      type: "GET",
      data: {
  ...
  $('body').on('click', '.change-status', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/tariff-plans/change-status/' + $(this).attr('id'),
      headers: authHeaders
  ...
  $('body').on('click', '.restore', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/tariff-plans/restore/' + $(this).attr('id'),
      headers: authHeaders
    }).then(function (response) {
      table.ajax.reload();
    });
...
/***/ 5:
/*!*****************************************************!*\
  !*** multi ./resources/js/acc/panel/tariffPlans.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\WEB\gym-control\resources\js\acc\panel\tariffPlans.js */"./resources/js/acc/panel/tariffPlans.js");
