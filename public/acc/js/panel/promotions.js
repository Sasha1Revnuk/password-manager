...
/***/ "./resources/js/acc/panel/promotions.js":
/*!**********************************************!*\
  !*** ./resources/js/acc/panel/promotions.js ***!
  \**********************************************/
...
$(document).ready(function () {
  var table = $('#promotions').DataTable({
    ...
    ajax: {
      url: '/account/api/object/' + $('#promotions').attr('data-object') + '/control-panel/promotions',
      type: "GET",
      data: {
  ...
  $('body').on('click', '.change-status', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/promotions/change-status/' + $(this).attr('id'),
      headers: authHeaders
  ...
  $('body').on('click', '.restore', function () {
    $.ajax({
      type: 'GET',
      url: '/account/api/object/' + $(this).attr('data-object') + '/control-panel/promotions/restore/' + $(this).attr('id'),
      headers: authHeaders
    }).then(function (response) {
      table.ajax.reload();
    });
...
/***/ 12:
/*!****************************************************!*\
  !*** multi ./resources/js/acc/panel/promotions.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\WEB\gym-control\resources\js\acc\panel\promotions.js */"./resources/js/acc/panel/promotions.js");
